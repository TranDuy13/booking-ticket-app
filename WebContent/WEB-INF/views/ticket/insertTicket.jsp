                ...
                <div class="booking__container">
                    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
                        <div class="wrapper wrapper--w790">
                            <div>
                                <div class="card-body">
                                    <form action="${planes.idplane}.htm"   method="post" onsubmit="return kiemtra()">
                                        
                                        <div class="form-row">
                                            <div class="name">ID</div>
                                            <div class="value">
                                                <div class="input-group">
                                                    <input class="input--style-5" type="text" 	name="idticket"/>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <div class="input-group">
                                                    <input class="input--style-5" type="number" name="price" min="25" max="10000" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <div class="input-group">
                                                    <input class="input--style-5" type="number" name="discount" min="0" max="99">
...
<!-- React js -->
    ...
    <script>
        function kiemtra(){
            var IDTicket = document.formAddTicket.IDTicket.value;
            var price = document.formAddTicket.price.value;
            var discount = document.formAddTicket.discount.value;
            var plane = document.formAddTicket.plane.value;

            if (IDTicket=="") { //quy tắc 1
                document.getElementById("baoloi").innerHTML="Please enter the ID Ticket !!!";
                return false;
            }
            if (price=="") { //quy tắc 1
                document.getElementById("baoloi").innerHTML="Please enter the PRICE !!!";
                return false;
            }
            if (discount=="") { //quy tắc 1
                document.getElementById("baoloi").innerHTML="Please enter the DISCOUNT !!!";
                return false;
            }
            if (plane=="") { //quy tắc 1
                document.getElementById("baoloi").innerHTML="Please enter the ID PLANE !!!";
                return false;
            }
