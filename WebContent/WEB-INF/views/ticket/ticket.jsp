            ...
            <div class="nav_bav">
                ...
                <div class="container">
                 ...
                 <div class="best_offer--items">
                                <div style="color: #73b860" class="best_offer--item-img">
									 ${planes.airline }
                                </div>
...
<%--                             </c:forEach> --%>
                    ...
                    <a href="admin/insertTicket/${planes.idplane}.htm">
   					   ...
   					   <c:forEach var = "b" items = "${tickets}">
                            ...
                            <c:choose>
								...
								<th>${b.discount}%</th>
                                <td class="a12">
                                	<a class="a1" href="admin/${b.idticket}.htm?linkEdit" class="edit_tour">
										<img src="http://localhost:8080/PTITHCM/img/icon/icon-card/pencil-square.svg" alt="">	
									</a>
									<a class="a1" href="admin/tickets/${b.idticket}.htm?linkDelete" class="edit_tour">
