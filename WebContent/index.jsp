        ...
        <div class="grid">
            ...
            <div class="container">
                ...
                <div class="special_offer">
                    ...
                    <div class="list__offers">
                        <!-- =================ITEMS================== -->
                        <div class="offer__item">
                            <div class="offer__item--img">
                                <img src="http://localhost:8080/PTITHCM/img/Special-offer/Image1.svg" alt="">
                            </div>
                            <div>
                                <div class="sub--title">
                                    <p>CITYTUCH</p>
                                ...
                                <div class="offer__title">
                                    <p>Up to $599 discount</p>
                                </div>
                                <span class="description">Domestic flight</span>
                                <div class="sub__offer__item">
                                    <div class="offer__item--cupon">
                                        <p>Cupon: <b>DHSHJAB09D</b></p>
                                    </div>
                                    <a href="booking.htm">
                    ...
                    <div class="deals">
                        <div class="deals-container">
                            <div class="deals__text">
                                <h3 class="deals__title">Book Your Perfect Deals</h3>
                                <div class="deals__cost">
                                    <h3 class="deals__cost__number">$547</h3>
                                    <span>STATING AT</span>
                                </div>
                            </div>
                            <a href="booking.htm">
